...
DECLARE_COMPONENT_VERSION("Filter Tree Component","1.0","Build and applies tree of filters. By Viktor Stolbovoy, 2016");


// This will prevent users from renaming your component around (important for proper troubleshooter behaviors) or loading multiple instances of it.
VALIDATE_COMPONENT_FILENAME("foo_filtertree.dll");
